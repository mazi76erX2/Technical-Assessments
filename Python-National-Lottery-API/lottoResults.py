...
class LottoCountry(Lotto):
    ...
    def get_all_results(self):
        """Allows the user to view all the results of a country's lottery.
    ...
    def get_all_tickets(self):
        """Allows the user to view all the tickets and winners of a country's lottery.
...
if __name__ == "__main__":
    ...
    print('Germany Results:')
    print(germany.get_all_results())
    print('')
    print('Germany Tickets:')
    print(germany.get_all_tickets())
